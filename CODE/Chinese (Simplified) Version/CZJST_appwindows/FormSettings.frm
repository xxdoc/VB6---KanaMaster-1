...
Begin VB.Form FormSettings 
   ...
   Begin VB.Frame FrameFonts 
      ...
      Begin VB.Label LabelFontsEngFontRecommendation 
         ...
         Caption         =   "推荐字体：Microsoft Sans Serif, Source Sans, Helvetica."
         BeginProperty Font 
            Name            =   "宋体"
            Size            =   9.75
            Charset         =   0
      ...
      Begin VB.Label LabelFontsJpnFontRecommendation 
         ...
         BackColor       =   &H000000FF&
         BackStyle       =   0  'Transparent
         Caption         =   "推荐字体：MS PGothic, MS PMincho, Source Han, Hiragino, Shin-Go, Kyokasho."
         BeginProperty Font 
            Name            =   "宋体"
            Size            =   9.75
            Charset         =   0
   ...
   Begin VB.Frame FrameGameMode 
      ...
      Begin VB.OptionButton RadioboxGameModeKana 
         Appearance      =   0  'Flat
         BackColor       =   &H00D0D0D0&
         Caption         =   "遍历设定范围内的所有假名（抽选过且答对过所有假名后胜利）"
         BeginProperty Font 
            Name            =   "宋体"
            Size            =   9.75
            Charset         =   0
...
'[] COMMANDS []
    ...
    Public Sub CmdFontsApply_Click()
        ...
        MsgBox "字体已更换！", vbInformation + vbOKOnly + vbDefaultButton1, "假名征服者"
    End Sub
