...
Begin VB.Form FormMainWindow 
   ...
   Caption         =   "假名征服者　v0.21　Sam Toki 制作"
   ClientHeight    =   11670
   ClientLeft      =   45
   ClientTop       =   750
   ClientWidth     =   18600
   ...
   Begin VB.Menu MenuAbout 
      ...
      Begin VB.Menu MenuAboutVersion 
         Caption         =   "v0.21 Beta Version　|　for Windows 7,8,10　|　中文（简体）"
      End
      Begin VB.Menu MenuAboutDate 
         Caption         =   "最近一次编译于 2020/9/20 周日"
      End
      Begin VB.Menu MenuAboutFirst 
         Caption         =   "首个版本编译于 2020/3/18 周三"
      End
...
'
'  Powered by Sam Toki
'  Version: v0.21 Beta Version 简体中文公测版
'  Date:    09/20/2020 (Sun.)
    ...
    Public Sub TextboxInput_Change()
        Select Case TextboxInput.Text
            ...
            Case ""
                Exit Sub
            Case Else
                MsgBox "注意：无效输入。您按下了错误的按键。请确认您的手指是否抵在了正确的三个按键上面。", vbExclamation + vbOKOnly + vbDefaultButton1, "假名征服者"
        End Select
...
'[] TIMERS []
    ...
    Public Sub TimerSettingsRefresher_Timer()
        'Game Difficulty Index Indicator...
            ...
            If gamedifficultyindex >= 100 Then gamedifficultyindexindicatordescription = "日语初心者 —— 简单级别"
            If gamedifficultyindex >= 300 Then gamedifficultyindexindicatordescription = "假名驾驭者 —— 普通级别"
            If gamedifficultyindex >= 500 Then gamedifficultyindexindicatordescription = "假名征服者 —— 困难级别"
            If gamedifficultyindex >= 700 Then gamedifficultyindexindicatordescription = "这种难度连土生土长的日本人都搞不定"
            If gamedifficultyindex >= 800 Then gamedifficultyindexindicatordescription = "日语大魔王 —— 地狱级别"
    ...
    Public Sub TimerCalculator_Timer()
        ...
        'Game Progress calculator...
            ...
            If gametotalkana = 0 Then
                MsgBox "注意：不可以排除所有假名。将恢复 [包括的假名] 到默认设定。", vbExclamation + vbOKOnly + vbDefaultButton1, "假名征服者"
                'setkanaswitch = Array("!!", True, True, True, True, True, True, True, True, True, True, False)
 ...
 _
                ...
                Case 1
                    ...
                    gamecurrenttimeleft = gamecurrenttimeleft - 1
                    LabelStatusbar.Caption = "遍历假名 " & gamekanarepeatedtimescount & "/" & gametotalkana & " --- 总计数 " & gametotalcount & " --- " & gamecombocount & " 连击 --- 最高 " & gamecombobest & " 连击 --- 失误数 " & gamemistakecount & "/" & setmistakeallowedamount
                ...
                Case 9
                    ...
                    Case 0
                        ...
                        Case 4
                            GoTo TimerCalculator_ForceExitSelectCaseGameStatus_
                Case Else
                    MsgBox "错误：Game status is out of range." & vbCrLf & "请向我们提供反馈以帮助解决问题。感谢您的支持！", vbCritical + vbOKOnly + vbDefaultButton1, "假名征服者"
            End Select
    ...
    Public Sub GameStatusRefresher()
        Select Case gamestatus
            ...
            Case 0
                ...
                LabelStatusbar.Caption = "点击 [开始] 来大干一场！"
    ...
    Public Sub GameQuestioner()
        ...
        'Step 2: The correct option...
            ...
            Select Case correctanswer
                ...
                Case Else
                    MsgBox "错误：Correct answer is out of range." & vbCrLf & "请向我们提供反馈以帮助解决问题。感谢您的支持！", vbCritical + vbOKOnly + vbDefaultButton1, "假名征服者"
            End Select
    ...
    Public Sub GameRespondent()
        ...
        If chosenanswer = correctanswer Then
            ...
            If gameprogress >= 100 Then
                ...
                MsgBox "祝贺！！挑战成功！" & vbCrLf & "稍后将显示本局游戏的详情。", vbInformation + vbOKOnly + vbDefaultButton1, "假名征服者"
        ...
        Else
            ...
            Select Case chosenanswer
                ...
                Case Else
                    MsgBox "错误：Chosen answer is out of range." & vbCrLf & "请向我们提供反馈以帮助解决问题。感谢您的支持！", vbCritical + vbOKOnly + vbDefaultButton1, "假名征服者"
            End Select
            ...
            If gamemistakecount > setmistakeallowedamount Then
                ...
                MsgBox "很遗憾... 您未能挑战成功。" & vbCrLf & "您已完成进度 " & Format(gameprogress, "0.00") & "%.", vbInformation + vbOKOnly + vbDefaultButton1, "假名征服者"
